...
#        COMPOSE_PLAYBOOK=<name>.yml to select a playbook under ansible/playbooks/ (default deploy-aws-poc.yml).
...
COMPOSE_PLAYBOOK_VALUE="${COMPOSE_PLAYBOOK-deploy-aws-poc.yml}"
