...
# This deployment runs environment = "dev" (terraform/aws.tfvars). windows-wsus uses "test";
# the value is part of the identity a resource must carry to be considered reapable, so a
# mismatch here makes the sweep refuse everything rather than delete the wrong thing.
